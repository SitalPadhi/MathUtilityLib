...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Sital Padhi/MathUtilityLib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Sital Padhi' => 'padhi.sital1@gmail.com' }
  s.source           = { :git => 'https://github.com/Sital Padhi/MathUtilityLib.git', :tag => s.version.to_s }
